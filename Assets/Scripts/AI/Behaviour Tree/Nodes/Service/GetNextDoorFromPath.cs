...
{
    public class GetNextDoorFromPath : UpdateBlackboardService
    {
        ...
        public GetNextDoorFromPath(BehaviourTree behaviourTree, string doorPathBlackboardKey, string doorPathIndexBlackboardKey, string targetBlackboardKey) : base(behaviourTree)
        {
